...
import ar.com.ada.api.cash.repositories.LoanRepository;
...
public class LoanService extends GenericService<Loan> {
    ...
    /**
     * Con este metodo ejecuto el SP, recorro los items(LoanFrankReport) y lo transformamos
     * a un LOAN.
     * @return
     */
...
//ATENCION: ESTE CODIGO NO ESTA PROBADO, hacer un controller en tal caso.
    ...
    public List<Loan> getAllUsingSPVersionAntigua() {
      ...
      //ATENCION!!!: PSEUDOCODIGO: No necesariamente es un codigo funcional
       ...
       //RECORRER el rawdata y andar leyendo los items. Usar el watch para ver el formato.
       return resultado;
